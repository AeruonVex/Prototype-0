...
await conn.sendMessage(m.chat, {image: img1, caption: `*𝙷𝙾𝙻𝙰 𝚄𝚂𝚄𝙰𝚁𝙸𝙾 👋🏻, 𝚃𝙴 𝙸𝙽𝚅𝙸𝚃𝙾 𝙰 𝚄𝙽𝙸𝚁𝚃𝙴 𝙰 𝙻𝙾𝚂 𝙶𝚁𝚄𝙿𝙾𝚂 𝙾𝙵𝙸𝙲𝙸𝙰𝙻𝙴𝚂 𝙳𝙴 †𝐃⃟𝕺𝐑⃯𝐑𝐇⃯𝚵𝐓᪣𝕭⃯𝚹⃯𝐓⃤ 𝙿𝙰𝚁𝙰 𝙲𝙾𝙽𝚅𝙸𝚅𝙸𝚁 𝙲𝙾𝙽 𝙻𝙰 𝙲𝙾𝙼𝚄𝙽𝙸𝙳𝙰𝙳 :D*
...
> pkg install yarn
> git clone https://github.com/DIEGO-OFC/DORRAT-BOT-MD-PLUS
> cd DORRAT-BOT-MD-PLUS
> yarn install 
> npm install
> npm install 
> npm start
...
`.trim();
await conn.sendMessage(m.chat, { image: { url: "https://telegra.ph/file/dde9bd1f999297449d139.jpg", },  caption: text, contextInfo: {externalAdReply: {  
            title: "𝙸𝙽𝙵𝙾𝚁𝙼𝙰𝙲𝙸𝙾𝙽 - 𝙸𝙽𝚂𝚃𝙰𝙻𝙰𝚁𝙱𝙾𝚃",
            body: "†𝐃⃟𝕺𝐑⃯𝐑𝐇⃯𝚵𝐓᪣𝕭⃯𝚹⃯𝐓⃤†",
            sourceUrl: "https://github.com/DIEGO-OFC/DORRAT-BOT-MD-PLUS",  
            mediaType: 1,  
            showAdAttribution: true,  
            thumbnailUrl: "https://telegra.ph/file/dde9bd1f999297449d139.jpg",  
          },  
